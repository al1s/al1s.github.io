...
BLOG_AUTHOR = "alstof"  # (translatable)
BLOG_TITLE = "Learn another day"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://al1s.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://al1s.github.io/"
BLOG_EMAIL = "alstof@gmail.com"
BLOG_DESCRIPTION = "Notes collection"  # (translatable)
